...
export default function OrderShippedEmail(props: {
  orderNumber: string
  trackingUrl?: string
  ...
  return (
    <div style={{ fontFamily: "Inter, Arial, sans-serif", color: "#111", padding: "24px" }}>
      <h1 style={{ fontSize: "20px", margin: "0 0 8px" }}>Your Order is on the way</h1>
      <p style={{ margin: "0 0 16px" }}>Order <strong>{orderNumber}</strong> has shipped.</p>
